...
namespace Download.NodeSystem {
    public class FurnaceStone : Folder {
        ...
        public FurnaceStone(Folder parent, string name, NodeCreateOptions? options = null) : base(parent, name, options) {
        ...
        public override string GetPrintString(string indent) {
            string result = $"{indent}FurnaceStone: {Name}\n";
            foreach (var child in Children) {
                result += child.GetPrintString(indent + "  ");
            }
            return result;
        }
        public static new IStaticNode StaticNode => FurnaceStoneStatic.Instance;
